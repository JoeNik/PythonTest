...
# 1.代码登录
# 1.1 登录的网址
login_url = "http://191.168.4.1/ac_portal/disclaimer/pc.html?template=disclaimer&tabs=pwd&vlanid=0&_ID_=0&switch_url=&url=https%3A//hao.360.com/?wd_xp1&controller_type=&mac=00-00-00-00-00-00"
login_form_data = {
    "opr": "pwdLogin",
    "userName": "翁兆炜",
    "pwd": psw,
